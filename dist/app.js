...
var _PhotonPulseSize = require("../Config/AppConfig.js");
    ...
    function basisGenerator() {
        ...
        return regeneratorRuntime.wrap(function basisGenerator$(context$2$0) {
            while (1) switch (context$2$0.prev = context$2$0.next) {
                ...
                case 1:
                    if (!(i < _PhotonPulseSize.PhotonPulseSize)) {
                        context$2$0.next = 7;
                        break;
                    }
...
var PhotonPulseSize = 128;exports.PhotonPulseSize = PhotonPulseSize;
...
var _import = require("../Constants/Polarizations.js");

var Polarizations = _interopRequireWildcard(_import);
