...
var _PhotonsSize = require("../Config/AppConfig.js");
...
var getReceiver = function getReceiver() {
    ...
    function calculateBit(basis, polarization) {
        ...
        if (basis === _Diagonal$Rectangular.Rectangular) {
            if (polarization === _Degrees.Degrees.Zero) {
                return 0;
            } else {
                return 1;
            }
        } else {
            if (polarization === _Degrees.Degrees.FortyFive) {
                return 0;
            } else {
                return 1;
            }
    ...
    function measure(basisToMeasureIn) {
        if (isValidBasis(basisToMeasureIn)) {
            if (Basis === basisToMeasureIn) {
                ...
                if (Basis === _Diagonal$Rectangular.Diagonal) {
                    if (randomPolarBit === 0) {
                        return _Degrees.Degrees.FortyFive;
                    } else if (randomPolarBit === 1) {
                        return _Degrees.Degrees.OneHundredThirtyFive;
                    }
                } else if (Basis === _Diagonal$Rectangular.Rectangular) {
                    if (randomPolarBit === 0) {
                        return _Degrees.Degrees.Zero;
                    } else if (randomPolarBit === 1) {
                        return _Degrees.Degrees.Ninety;
...
var _getSender = require("./Actors/Sender.js");

var _getReceiver = require("./Actors/Receiver.js");

var _QuantumChannel = require("./Channels/QuantumChannel.js");

var Sender = _getSender.getSender(),
    Receiver = _getReceiver.getReceiver();

Sender.generateRandomBits();
Sender.generateRandomBasis();
Sender.calculatePolarizations();
Sender.sendPhotonsToChannel(_QuantumChannel.QuantumChannel);

//Attacker.interceptPhotonsFromChannel(QuantumChannel);

Receiver.generateRandomBasis();
Receiver.measurePhotonsFromChannel(_QuantumChannel.QuantumChannel);

Sender.sendBasisToChannel(_QuantumChannel.QuantumChannel);
//Attacker.interceptSenderBasisFromChannel(QuantumChannel);
Receiver.readBasisFromChannel(_QuantumChannel.QuantumChannel);

Receiver.sendBasisToChannel(_QuantumChannel.QuantumChannel);
//Attacker.interceptReceiverBasisFromChannel(QuantumChannel);
Sender.readBasisFromChannel(_QuantumChannel.QuantumChannel);
